...
<Card title="About Me" bordered={false} style={{ width: 250 , borderRadius: '0.9em' }}>
...
<Card title="Critika Score" bordered={false} style={{ width: 250 , borderRadius: '0.9em', marginBottom: '20px' }}>
    ...
    <h1>2.0</h1>
      ...
      <Col span={8}>
      <Card title="Badges" bordered={false} style={{ width: 250, borderRadius: '0.9em', marginBottom: '20px'  }}>
...
<p> Received 100 likes on comments<Icon type="like" theme="outlined" /></p>
      ...
      <Col span={8}>
        <Card title="Personal Information" bordered={false} style={{borderRadius: '0.9em',marginBottom: '20px' }}>
