...
export class SubmissionService{
    ...
    addSubmission(submissionname: string, submissiontext: string, category:string, submissionlink:string,
        ...
        return this.http.post("http://secure-peak-43679.herokuapp.com/submission/add", submission)
    ...
    editSubmission(submissionLink: string, submissionDescription: string, submissionDesiredFeedback: string, submissionID: string){
        ...
        return this.http.post("http://secure-peak-43679.herokuapp.com/submission/edit", submission)
    ...
    getAvailable(){
        return this.http.get("http://secure-peak-43679.herokuapp.com/submission/available-with-categories").toPromise();
    }

    //get user's submissions
    getSubmissions():Promise<Submission[]>{
        return this.http.get<Submission[]>("http://secure-peak-43679.herokuapp.com/submission/mine").toPromise()
    }
    ...
    spendCoins(username1: string, coins1: string){
        ...
        console.log (p)
        this.http.post("http://secure-peak-43679.herokuapp.com/user/remove-coin", p)
        .subscribe((response) => {
    ...
    setUnavailable(submission){
        ...
        console.log(sub)
        return this.http.post("http://secure-peak-43679.herokuapp.com/submission/make-unavailable", sub).toPromise();
    }
    ...
    addComment(comment, submissionID){
        ...
        return this.http.post<Object>("http://secure-peak-43679.herokuapp.com/submission/add-comment", options).toPromise();
    }


    getAllReportedComments(){
        return this.http.get("http://secure-peak-43679.herokuapp.com/submission/all").toPromise();
    }

    getLeaderboard() {
        return this.http.get("http://secure-peak-43679.herokuapp.com/user/leaderboard").toPromise();
    }

    getLeaderboardReverse() {
        return this.http.get("http://secure-peak-43679.herokuapp.com/user/leaderboard-reverse").toPromise();
    }
    ...
    reportComment(commentID:string, submissionID:string, reportedMessage:string){
        ...
        return this.http.post("http://secure-peak-43679.herokuapp.com/submission/report-comment",sub).toPromise();
