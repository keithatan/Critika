...
export class SubmissionService{
    ...
    addSubmission(submissionname: string, submissiontext: string, category:string, submissionlink:string,
        ...
        return this.http.post("https://critika-backend.herokuapp.comsubmission/add", submission)
    ...
    editSubmission(submissionLink: string, submissionDescription: string, submissionDesiredFeedback: string, submissionID: string){
        ...
        return this.http.post("https://critika-backend.herokuapp.comsubmission/edit", submission)
    ...
    getAvailable(){
        return this.http.get("https://critika-backend.herokuapp.comsubmission/available-with-categories").toPromise();
    }

    //get user's submissions
    getSubmissions():Promise<Submission[]>{
        return this.http.get<Submission[]>("https://critika-backend.herokuapp.comsubmission/mine").toPromise()
    }
    ...
    spendCoins(username1: string, coins1: string){
        ...
        console.log (p)
        this.http.post("https://critika-backend.herokuapp.comuser/remove-coin", p)
        .subscribe((response) => {
    ...
    setUnavailable(submission){
        ...
        console.log(sub)
        return this.http.post("https://critika-backend.herokuapp.comsubmission/make-unavailable", sub).toPromise();
    }
    ...
    addComment(comment, submissionID){
        ...
        return this.http.post<Object>("https://critika-backend.herokuapp.comsubmission/add-comment", options).toPromise();
    }


    getAllReportedComments(){
        return this.http.get("https://critika-backend.herokuapp.comsubmission/all").toPromise();
    }

    getLeaderboard() {
        return this.http.get("https://critika-backend.herokuapp.comuser/leaderboard").toPromise();
    }

    getLeaderboardReverse() {
        return this.http.get("https://critika-backend.herokuapp.comuser/leaderboard-reverse").toPromise();
    }
    ...
    reportComment(commentID:string, submissionID:string, reportedMessage:string){
        ...
        return this.http.post("https://critika-backend.herokuapp.comsubmission/report-comment",sub).toPromise();
